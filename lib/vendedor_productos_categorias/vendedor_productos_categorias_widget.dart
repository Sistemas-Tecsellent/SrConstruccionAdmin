...
class VendedorProductosCategoriasWidget extends StatefulWidget {
  const VendedorProductosCategoriasWidget({Key key}) : super(key: key);

  @override
  _VendedorProductosCategoriasWidgetState createState() =>
      _VendedorProductosCategoriasWidgetState();
}

class _VendedorProductosCategoriasWidgetState
    extends State<VendedorProductosCategoriasWidget> {
