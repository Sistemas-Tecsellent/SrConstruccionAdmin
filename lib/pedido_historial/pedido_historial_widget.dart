...
class PedidoHistorialWidget extends StatefulWidget {
  const PedidoHistorialWidget({Key key}) : super(key: key);

  @override
  _PedidoHistorialWidgetState createState() => _PedidoHistorialWidgetState();
}

class _PedidoHistorialWidgetState extends State<PedidoHistorialWidget> {
