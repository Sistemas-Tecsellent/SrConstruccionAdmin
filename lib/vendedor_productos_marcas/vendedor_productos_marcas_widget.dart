...
class VendedorProductosMarcasWidget extends StatefulWidget {
  const VendedorProductosMarcasWidget({Key key}) : super(key: key);

  @override
  _VendedorProductosMarcasWidgetState createState() =>
      _VendedorProductosMarcasWidgetState();
}

class _VendedorProductosMarcasWidgetState
    extends State<VendedorProductosMarcasWidget> {
