...
class AnadirVarianteWidget extends StatefulWidget {
  const AnadirVarianteWidget({Key key}) : super(key: key);

  @override
  _AnadirVarianteWidgetState createState() => _AnadirVarianteWidgetState();
}

class _AnadirVarianteWidgetState extends State<AnadirVarianteWidget> {
