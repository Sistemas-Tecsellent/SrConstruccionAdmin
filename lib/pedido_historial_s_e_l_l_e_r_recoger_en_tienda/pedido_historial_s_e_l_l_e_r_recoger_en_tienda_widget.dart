...
class PedidoHistorialSELLERRecogerEnTiendaWidget extends StatefulWidget {
  const PedidoHistorialSELLERRecogerEnTiendaWidget({Key key}) : super(key: key);

  @override
  _PedidoHistorialSELLERRecogerEnTiendaWidgetState createState() =>
      _PedidoHistorialSELLERRecogerEnTiendaWidgetState();
}

class _PedidoHistorialSELLERRecogerEnTiendaWidgetState
    extends State<PedidoHistorialSELLERRecogerEnTiendaWidget> {
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec quam mauris, molestie et mi id, lobortis pellentesque odio. Nullam vehicula venenatis orci et suscipit. Mauris porta ut lacus eu pharetra.',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyText1,
                                                          ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Privada San José Cocoyoc #3 Col. Lomas de Ahuatlán, Cuernavaca, Morelos 62130',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                              fontFamily: 'Montserrat',
