...
import '../usuario_pedidos/usuario_pedidos_widget.dart';
...
class UsuarioHistorialWidget extends StatefulWidget {
  const UsuarioHistorialWidget({Key key}) : super(key: key);

  @override
  _UsuarioHistorialWidgetState createState() => _UsuarioHistorialWidgetState();
}

class _UsuarioHistorialWidgetState extends State<UsuarioHistorialWidget> {
