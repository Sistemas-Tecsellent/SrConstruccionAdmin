...
class VendedordatosbancariosWidget extends StatefulWidget {
  const VendedordatosbancariosWidget({Key key}) : super(key: key);

  @override
  _VendedordatosbancariosWidgetState createState() =>
      _VendedordatosbancariosWidgetState();
}

class _VendedordatosbancariosWidgetState
    extends State<VendedordatosbancariosWidget> {
