                      ...
                      children: [
                          ...
                          child: StreamBuilder<List<OrderBundlesRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<OrderBundlesRecord>
                                  gridViewOrderBundlesRecordList =
                                  snapshot.data;
                              return GridView.builder(
                                ...
                                itemCount:
                                    gridViewOrderBundlesRecordList.length,
                                itemBuilder: (context, gridViewIndex) {
                                  final gridViewOrderBundlesRecord =
                                      gridViewOrderBundlesRecordList[
                                          gridViewIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        context.pushNamed(
                                          'PorAceptar',
                                          queryParams: {
                                            'orderBundle': serializeParam(
                                                gridViewOrderBundlesRecord.id,
                                                ParamType.String),
                                          }.withoutNulls,
                                        );
                                      },
                        ...
                        Container(
                          ...
                          child: StreamBuilder<List<OrderBundlesRecord>>(
                            stream: queryOrderBundlesRecord(
                              queryBuilder: (orderBundlesRecord) =>
                                  orderBundlesRecord.where('status',
                                      isEqualTo: 'inactive'),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
