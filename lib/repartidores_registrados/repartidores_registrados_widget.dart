...
import '../components/is_deliverer_approved_widget.dart';
...
import '../repartidores_por_aprobar/repartidores_por_aprobar_widget.dart';
...
class RepartidoresRegistradosWidget extends StatefulWidget {
  const RepartidoresRegistradosWidget({Key key}) : super(key: key);

  @override
  _RepartidoresRegistradosWidgetState createState() =>
      _RepartidoresRegistradosWidgetState();
}

class _RepartidoresRegistradosWidgetState
    extends State<RepartidoresRegistradosWidget> {
                              ...
                              onTap: () async {
                                await Navigator.push(
                                  ...
                                  PageTransition(
                                    ...
                                    duration: Duration(milliseconds: 0),
                                    reverseDuration: Duration(milliseconds: 0),
                                    child: RepartidoresPorAprobarWidget(),
                                  ),
                                );
                              },
                              child: Text(
                                ...
                                child: StreamBuilder<List<DeliverersRecord>>(
                                  stream: queryDeliverersRecord(
                                    queryBuilder: (deliverersRecord) =>
                                        deliverersRecord.where('isApproved',
                                            isEqualTo: true),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewDeliverersRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewDeliverersRecord =
                                            listViewDeliverersRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
