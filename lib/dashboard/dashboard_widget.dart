...
import '../ingresacostodeenvio/ingresacostodeenvio_widget.dart';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final dashboardIsUserAdminResponse = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          ...
          body: GestureDetector(
            ...
            child: Visibility(
              visible: IsUserAdminCall.response(
                    (dashboardIsUserAdminResponse?.jsonBody ?? ''),
                  ) ??
                  true,
              child: Row(
                mainAxisSize: MainAxisSize.max,
                          ...
                          children: [
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Row(
                                  ...
                                  children: List.generate(
                                      rowPricingRequestsRecordList.length,
                                      (rowIndex) {
                                    final rowPricingRequestsRecord =
                                        rowPricingRequestsRecordList[rowIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0, 0, 20, 0),
                                      child: InkWell(
                                        onTap: () async {
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              reverseDuration:
                                                  Duration(milliseconds: 0),
                                              child: IngresacostodeenvioWidget(
                                                orderId:
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'Ventas Totales de Pedidos Completados',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyText1
                                                        .override(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'Totales de Pedidos Completados',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyText1
                                                        .override(
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Image.network(
                                  'https://user-images.githubusercontent.com/466765/28550962-d301c690-7138-11e7-95c5-6f7414d5d173.png',
                                  width: 100,
                                  fit: BoxFit.contain,
                                ),
                              ),
