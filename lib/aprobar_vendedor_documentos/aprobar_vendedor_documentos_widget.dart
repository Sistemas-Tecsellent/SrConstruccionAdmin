...
class AprobarVendedorDocumentosWidget extends StatefulWidget {
  const AprobarVendedorDocumentosWidget({Key key}) : super(key: key);

  @override
  _AprobarVendedorDocumentosWidgetState createState() =>
      _AprobarVendedorDocumentosWidgetState();
}

class _AprobarVendedorDocumentosWidgetState
    extends State<AprobarVendedorDocumentosWidget> {
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                context.pushNamed('AprobarVendedorDetalles');
                              },
                              child: Container(
                                width: 150,
                                decoration: BoxDecoration(
