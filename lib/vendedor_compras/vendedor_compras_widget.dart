...
class VendedorComprasWidget extends StatefulWidget {
  const VendedorComprasWidget({Key key}) : super(key: key);

  @override
  _VendedorComprasWidgetState createState() => _VendedorComprasWidgetState();
}

class _VendedorComprasWidgetState extends State<VendedorComprasWidget> {
