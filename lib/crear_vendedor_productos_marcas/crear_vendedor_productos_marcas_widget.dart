...
class CrearVendedorProductosMarcasWidget extends StatefulWidget {
  const CrearVendedorProductosMarcasWidget({Key key}) : super(key: key);

  @override
  _CrearVendedorProductosMarcasWidgetState createState() =>
      _CrearVendedorProductosMarcasWidgetState();
}

class _CrearVendedorProductosMarcasWidgetState
    extends State<CrearVendedorProductosMarcasWidget> {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context
                                    .pushNamed('CrearVendedorDatosBancarios');
                              },
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed('CrearVendedorDocumentos');
                              },
                              text: 'Documentos',
                              options: FFButtonOptions(
                                width: 150,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: () async {
                                                    context.pushNamed(
                                                      'CrearVendedorProductosCategorias',
                                                      extra: <String, dynamic>{
                                                        kTransitionInfoKey:
                                                            TransitionInfo(
                                                          hasTransition: true,
