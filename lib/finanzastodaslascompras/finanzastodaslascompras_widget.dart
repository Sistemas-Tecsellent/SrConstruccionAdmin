...
import '../estadodecuenta/estadodecuenta_widget.dart';
...
class FinanzastodaslascomprasWidget extends StatefulWidget {
  const FinanzastodaslascomprasWidget({Key key}) : super(key: key);

  @override
  _FinanzastodaslascomprasWidgetState createState() =>
      _FinanzastodaslascomprasWidgetState();
}

class _FinanzastodaslascomprasWidgetState
    extends State<FinanzastodaslascomprasWidget> {
