...
class DetallesCotizacionProductosWidget extends StatefulWidget {
  const DetallesCotizacionProductosWidget({Key key}) : super(key: key);

  @override
  _DetallesCotizacionProductosWidgetState createState() =>
      _DetallesCotizacionProductosWidgetState();
}

class _DetallesCotizacionProductosWidgetState
    extends State<DetallesCotizacionProductosWidget> {
  ...
  void initState() {
    super.initState();
    textController1 = TextEditingController(text: '25');
    textController2 = TextEditingController(text: '\$1,098');
    textController3 = TextEditingController(text: '-0.00%');
    textController4 = TextEditingController(text: '25');
    textController5 = TextEditingController(text: '\$1,098');
    textController6 = TextEditingController(text: '-0.00%');
    textController7 = TextEditingController(text: '25');
    textController8 = TextEditingController(text: '\$1,098');
    textController9 = TextEditingController(text: '-0.00%');
    textController10 = TextEditingController(text: '25');
    textController11 = TextEditingController(text: '\$1,098');
    textController12 = TextEditingController(text: '-0.00%');
    textController13 = TextEditingController(text: '\$1,035');
