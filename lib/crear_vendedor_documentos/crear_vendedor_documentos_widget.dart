...
class CrearVendedorDocumentosWidget extends StatefulWidget {
  const CrearVendedorDocumentosWidget({Key key}) : super(key: key);

  @override
  _CrearVendedorDocumentosWidgetState createState() =>
      _CrearVendedorDocumentosWidgetState();
}

class _CrearVendedorDocumentosWidgetState
    extends State<CrearVendedorDocumentosWidget> {
