...
class VerSellersWidget extends StatefulWidget {
  const VerSellersWidget({
    Key key,
    this.productId,
    this.variantId,
    this.amount,
  ...
  @override
  _VerSellersWidgetState createState() => _VerSellersWidgetState();
}

class _VerSellersWidgetState extends State<VerSellersWidget> {
  @override
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Builder(
                          builder: (context) {
                            final storesWithTheProduct = containerProductsRecord
                                    .stores
                                    .toList()
                                    ?.toList() ??
                                [];
                            return ListView.builder(
                              ...
                              itemCount: storesWithTheProduct.length,
                              itemBuilder:
                                  (context, storesWithTheProductIndex) {
                                final storesWithTheProductItem =
                                    storesWithTheProduct[
                                        storesWithTheProductIndex];
                                return StreamBuilder<List<StoresRecord>>(
                                  stream: queryStoresRecord(
                                    queryBuilder: (storesRecord) =>
                                        storesRecord.where('id',
                                            isEqualTo:
                                                storesWithTheProductItem),
                                    singleRecord: true,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
