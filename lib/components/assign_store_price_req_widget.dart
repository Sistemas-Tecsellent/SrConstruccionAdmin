...
class AssignStorePriceReqWidget extends StatefulWidget {
  const AssignStorePriceReqWidget({
    Key key,
    this.storeId,
  ...
  @override
  _AssignStorePriceReqWidgetState createState() =>
      _AssignStorePriceReqWidgetState();
}

class _AssignStorePriceReqWidgetState extends State<AssignStorePriceReqWidget> {
  @override
              ...
              Container(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  future: GetSupplierInfoFromPriceReqCall.call(
                    ...
                    pricingRequestId: widget.pricingRequestId,
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                    ...
                    final columnGetSupplierInfoFromPriceReqResponse =
                        snapshot.data;
                    return Builder(
                      builder: (context) {
                        final availableProduct =
                            GetSupplierInfoFromPriceReqCall.canSupplyProducts(
                                  (columnGetSupplierInfoFromPriceReqResponse
                                          ?.jsonBody ??
                                      ''),
                                )?.toList() ??
                                [];
