...
class EditarCuponWidget extends StatefulWidget {
  const EditarCuponWidget({Key key}) : super(key: key);

  @override
  _EditarCuponWidgetState createState() => _EditarCuponWidgetState();
}

class _EditarCuponWidgetState extends State<EditarCuponWidget> {
  DateTime datePicked;
