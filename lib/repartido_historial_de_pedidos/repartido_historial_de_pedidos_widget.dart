...
import '../repartidor_pagos/repartidor_pagos_widget.dart';
...
class RepartidoHistorialDePedidosWidget extends StatefulWidget {
  const RepartidoHistorialDePedidosWidget({Key key}) : super(key: key);

  @override
  _RepartidoHistorialDePedidosWidgetState createState() =>
      _RepartidoHistorialDePedidosWidgetState();
}

class _RepartidoHistorialDePedidosWidgetState
    extends State<RepartidoHistorialDePedidosWidget> {
                            ...
                            onPressed: () async {
                              await Navigator.push(
                                ...
                                PageTransition(
                                  ...
                                  duration: Duration(milliseconds: 0),
                                  reverseDuration: Duration(milliseconds: 0),
                                  child: RepartidoHistorialDePedidosWidget(),
                                ),
                              );
                            },
                            text: 'Pedidos',
                                                ...
                                                Container(
                                                  ...
                                                  alignment:
                                                      AlignmentDirectional(
                                                          0, 0),
                                                  child: Text(
                                                    'Col. Lomas de Ahuatlán Privada San José Cocoyoc 3. Curenavaca Morelos, México, 62130',
                                                    textAlign: TextAlign.start,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyText1
