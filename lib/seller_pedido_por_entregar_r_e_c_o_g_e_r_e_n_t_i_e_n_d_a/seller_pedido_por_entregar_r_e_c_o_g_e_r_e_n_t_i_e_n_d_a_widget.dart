...
class SellerPedidoPorEntregarRECOGERENTIENDAWidget extends StatefulWidget {
  const SellerPedidoPorEntregarRECOGERENTIENDAWidget({
    Key key,
    this.bundleId,
    this.normalOrderId,
  }) : super(key: key);
  ...
  @override
  _SellerPedidoPorEntregarRECOGERENTIENDAWidgetState createState() =>
      _SellerPedidoPorEntregarRECOGERENTIENDAWidgetState();
}

class _SellerPedidoPorEntregarRECOGERENTIENDAWidgetState
    extends State<SellerPedidoPorEntregarRECOGERENTIENDAWidget> {
    ...
    return StreamBuilder<List<OrdersForClientsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForClientsRecord>
            sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecordList =
            snapshot.data;
        final sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecord =
            sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecordList
                    .isNotEmpty
                ? sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecordList
                    .first
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    5, 0, 0, 0),
                                            child: Text(
                                              sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecord
                                                  .id,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyText1
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        dateTimeFormat('M/d h:mm a', sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecord.createdDate),
                                                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                              fontFamily: 'Montserrat',
                                                                                              color: Colors.black,
                                                                                              fontSize: 14,
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 20),
                                                                                      child: Text(
                                                                                        sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecord.shipmentTimeText,
                                                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                              fontFamily: 'Montserrat',
                                                                                              color: Colors.black,
                                                                                              fontSize: 14,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              stream: queryStoresRecord(
                                                                                queryBuilder: (storesRecord) => storesRecord.where('id', isEqualTo: sellerPedidoPorEntregarRECOGERENTIENDAOrdersForClientsRecord.store),
                                                                                singleRecord: true,
                                                                              ),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
