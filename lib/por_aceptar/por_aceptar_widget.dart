...
import '../pedido_en_preparacion5_d_i_a_s/pedido_en_preparacion5_d_i_a_s_widget.dart';
import '../pedido_en_preparacion_e_x_p_r_e_s_s/pedido_en_preparacion_e_x_p_r_e_s_s_widget.dart';
import '../pedido_historial/pedido_historial_widget.dart';
import '../pedido_por_aceptar5_d_i_a_s/pedido_por_aceptar5_d_i_a_s_widget.dart';
import '../pedido_por_aceptar_e_x_p_r_e_s_s/pedido_por_aceptar_e_x_p_r_e_s_s_widget.dart';
import '../pedido_por_entregar5_d_i_a_s/pedido_por_entregar5_d_i_a_s_widget.dart';
import '../pedido_por_entregar_e_x_p_r_e_s_s/pedido_por_entregar_e_x_p_r_e_s_s_widget.dart';
...
class PorAceptarWidget extends StatefulWidget {
  const PorAceptarWidget({
    Key key,
    this.orderBundle,
  }) : super(key: key);
  ...
  @override
  _PorAceptarWidgetState createState() => _PorAceptarWidgetState();
}

class _PorAceptarWidgetState extends State<PorAceptarWidget> {
                ...
                child: StreamBuilder<List<OrderBundlesRecord>>(
                  stream: queryOrderBundlesRecord(
                    queryBuilder: (orderBundlesRecord) => orderBundlesRecord
                        .where('id', isEqualTo: widget.orderBundle),
                    singleRecord: true,
                  ),
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<OrdersForClientsRecord>
                                            pedidoOrdersForClientsRecordList =
                                            snapshot.data;
                                        // Return an empty Container when the document does not exist.
                                        if (snapshot.data.isEmpty) {
                                          return Container();
                                        }
                                        final pedidoOrdersForClientsRecord =
                                            pedidoOrdersForClientsRecordList
                                                    .isNotEmpty
                                                ? pedidoOrdersForClientsRecordList
                                                    .first
                                            ...
                                            await Navigator.push(
                                              ...
                                              PageTransition(
                                                ...
                                                child:
                                                  ...
                                                  bundleId: widget.orderBundle,
                                                  orderId:
                                                      pedidoOrdersForClientsRecord
                                                          .id,
                                                ),
                                              ),
                                            );
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            formatNumber(
                                                                              pedidoOrdersForClientsRecord.total,
                                                                ...
                                                                child: StreamBuilder<
                                                                  ...
                                                                  stream:
                                                                    ...
                                                                    queryBuilder: (usersRecord) => usersRecord.where(
                                                                        'uid',
                                                                        isEqualTo:
                                                                            pedidoOrdersForClientsRecord.customerId),
                                                                    singleRecord:
                                                                        true,
                                                                  ),
                                                                  builder: (context,
                                            ...
                                            await Navigator.push(
                                              ...
                                              PageTransition(
                                                ...
                                                reverseDuration:
                                                    Duration(milliseconds: 0),
                                                child:
                                                    PedidoEnPreparacionEXPRESSWidget(
                                                  bundleId: widget.orderBundle,
                                                  orderId:
                                                      pedidoOrdersForClientsRecord
                                                          .id,
                                            ...
                                            await Navigator.push(
                                              ...
                                              PageTransition(
                                                ...
                                                reverseDuration:
                                                    Duration(milliseconds: 0),
                                                child:
                                                    PedidoEnPreparacion5DIASWidget(
                                                  bundleId: widget.orderBundle,
                                                  orderId:
                                                      pedidoOrdersForClientsRecord
                                                          .id,
                                            ...
                                            await Navigator.push(
                                              ...
                                              PageTransition(
                                                ...
                                                reverseDuration:
                                                    Duration(milliseconds: 0),
                                                child:
                                                    PedidoPorEntregarEXPRESSWidget(
                                                  bundleId: widget.orderBundle,
                                                  orderId:
                                                      pedidoOrdersForClientsRecord
                                                          .id,
