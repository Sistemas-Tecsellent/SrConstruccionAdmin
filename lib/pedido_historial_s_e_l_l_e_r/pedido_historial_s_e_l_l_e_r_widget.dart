...
class PedidoHistorialSELLERWidget extends StatefulWidget {
  const PedidoHistorialSELLERWidget({Key key}) : super(key: key);

  @override
  _PedidoHistorialSELLERWidgetState createState() =>
      _PedidoHistorialSELLERWidgetState();
}

class _PedidoHistorialSELLERWidgetState
    extends State<PedidoHistorialSELLERWidget> {
