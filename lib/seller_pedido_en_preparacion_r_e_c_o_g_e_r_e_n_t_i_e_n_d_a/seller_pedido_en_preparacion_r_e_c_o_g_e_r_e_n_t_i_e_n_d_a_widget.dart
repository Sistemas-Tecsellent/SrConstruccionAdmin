...
class SellerPedidoEnPreparacionRECOGERENTIENDAWidget extends StatefulWidget {
  const SellerPedidoEnPreparacionRECOGERENTIENDAWidget({
    Key key,
    this.bundleId,
    this.normalOrderId,
  }) : super(key: key);
  ...
  @override
  _SellerPedidoEnPreparacionRECOGERENTIENDAWidgetState createState() =>
      _SellerPedidoEnPreparacionRECOGERENTIENDAWidgetState();
}

class _SellerPedidoEnPreparacionRECOGERENTIENDAWidgetState
    extends State<SellerPedidoEnPreparacionRECOGERENTIENDAWidget> {
    ...
    return StreamBuilder<List<OrdersForClientsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrdersForClientsRecord>
            sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecordList =
            snapshot.data;
        final sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecord =
            sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecordList
                    .isNotEmpty
                ? sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecordList
                    .first
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    5, 0, 0, 0),
                                            child: Text(
                                              sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecord
                                                  .id,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyText1
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        dateTimeFormat('M/d h:mm a', sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecord.createdDate),
                                                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                              fontFamily: 'Montserrat',
                                                                                              color: Colors.black,
                                                                                              fontSize: 14,
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0, 0, 0, 20),
                                                                                      child: Text(
                                                                                        sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecord.shipmentTimeText,
                                                                                        style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                              fontFamily: 'Montserrat',
                                                                                              color: Colors.black,
                                                                                              fontSize: 14,
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        StreamBuilder<List<StoresRecord>>(
                                                                                          stream: queryStoresRecord(
                                                                                            queryBuilder: (storesRecord) => storesRecord.where('id', isEqualTo: sellerPedidoEnPreparacionRECOGERENTIENDAOrdersForClientsRecord.store),
                                                                                            singleRecord: true,
                                                                                          ),
                                                                                          builder: (context, snapshot) {
                                                                                            // Customize what your widget looks like when it's loading.
